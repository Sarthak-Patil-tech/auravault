...
### Changed
- Wallpapers re-rendered as native 3200×2000 gradients (previously 1586px
  AI images that softened behind the glass on high-DPI displays).
- Documentation screenshots re-captured with a static-animation mode —
  sharper and never caught mid-transition.
...
[1.0.1]: https://github.com/your-username/auravault/releases/tag/v1.0.1
[1.0.0]: https://github.com/your-username/auravault/releases/tag/v1.0.0
